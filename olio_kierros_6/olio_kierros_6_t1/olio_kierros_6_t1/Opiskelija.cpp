...
// muokataan kantaluokan nimi- ja ikä-jäseniä 
void Opiskelija::muutaTiedot() {
    nimi = "Uusi Opiskelija"; // Toimii, koska nimi on protected
    ika = 25;                 // Toimii, koska ika on protected
}